...
`
export const ContainerCardsSkills = styled.div`
    margin-bottom: 5rem;
    margin-top: 3rem;
    width: 100%;
    height: auto;
...
export const CardsSkills = styled.div`
    ...
    /* border: 1px solid rgb(70, 183, 272); */
...
export const InfoIcons = styled.h5`
 font-size: 1rem;
`